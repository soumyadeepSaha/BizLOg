...
import './PaymentModal.css'; // Create this CSS file for styling
  ...
  return (
    <div className='fixed top-0 left-0 w-full h-full flex items-center justify-center bg-gray-800 bg-opacity-50'>
      <div className='bg-white p-8 rounded-lg max-w-md payment-modal'>
        <h2 className='text-xl text-slate-950 font-semibold mb-4'>Confirm Your Payment</h2>
        <form onSubmit={handlePayment}>
          <div className='mb-4'>
            ...
            <input
              type='text'
              id='owner'
              className='mt-1 block w-full px-3 py-2 border text-gray-600 rounded-md shadow-sm'
              required
            />
          </div>
          <div className='mb-4'>
